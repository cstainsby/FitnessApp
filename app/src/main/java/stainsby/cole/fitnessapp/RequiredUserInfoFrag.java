...
public class RequiredUserInfoFrag extends AuthenticationFragment{
    ...
    public static RequiredUserInfoFrag newInstance(String param1, String param2) {
        RequiredUserInfoFrag fragment = new RequiredUserInfoFrag();
